...
class fL_BLOCK:public Box
{
public:
	//const static int BOX_SIZE = 20; 
	
	fL_BLOCK(int left, int top, int r, int c):Box(left,top,r,c)
	{
...
class fL_BLOCK1:public Box
{
public:
	//const static int BOX_SIZE = 20; 
	
	fL_BLOCK1(int left, int top, int r, int c):Box(left,top,r,c)
	{
		//_row1 = Row() - BOX_SIZE + 1;
		//_col1 = Col() + BOX_SIZE - 1;
	}
...
class fL_BLOCK2:public Box
{
public:
	//const static int BOX_SIZE = 20; 
	
	fL_BLOCK2(int left, int top, int r, int c):Box(left,top,r,c)
	{
		//_row1 = Row() - BOX_SIZE + 1;
		//_col1 = Col() + BOX_SIZE - 1;
	}
...
class fL_BLOCK3:public Box
{
public:
	//const static int BOX_SIZE = 20; 
	
	fL_BLOCK3(int left, int top, int r, int c):Box(left,top,r,c)
	{
		//_row1 = Row() - BOX_SIZE + 1;
		//_col1 = Col() + BOX_SIZE - 1;
	}
